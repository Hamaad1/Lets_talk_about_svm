                            ...
                            for coef0_value in coef0:
                                for rep in range(repetitions):
                                    if kernel_value in ['poly', 'sigmoid']:#== 'poly':
                                        model = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon, degree=degree_value, coef0=coef0_value, tol=tol_value, max_iter=max_iter)
                                       ...
                                       # Create the split folder first
                                        ...
                                        model = SVR(C=C, kernel=kernel_value, gamma=gamma_value,epsilon=epsilon, tol=tol_value, max_iter=max_iter)#, epsilon={epsilon_value}
                                        model = MultiOutputRegressor(model, n_jobs=-1)
