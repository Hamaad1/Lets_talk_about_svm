                                ...
                                for coef0_value in coef0:
                                    for rep in range(repetitions):
                                        if kernel_value == 'poly':                              
                                            model = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon_value, degree=degree_value, tol=tol_value, max_iter=max_iter)
                                            model = MultiOutputRegressor(model, n_jobs=-1)

                                            # Perform cross-validation and calculate mean error
                                            cv_scores = cross_val_score(model, X_train_scaled, y_train, cv=kf, scoring='neg_mean_absolute_error', error_score='raise')
                                            ...
                                            model = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon_value, degree=degree_value, coef0=coef0_value, tol=tol, max_iter=max_iter)
                                            model = MultiOutputRegressor(model, n_jobs=-1)
                                            ...
                                            model = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon_value, tol=tol, max_iter=max_iter)
                                            model = MultiOutputRegressor(model, n_jobs=-1)
                                            ...
                                            model = SVR(C=C, kernel=kernel_value, epsilon=epsilon_value, tol=tol, max_iter=max_iter)
                                            model = MultiOutputRegressor(model, n_jobs=-1)
