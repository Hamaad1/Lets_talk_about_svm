                    ...
                    for coef0_value in coef0:
                        for rep in range(repetitions):
                            if kernel_value in ['poly', 'sigmoid']:# == 'poly':
                                svr_lat = SVR(C=C, kernel=kernel_value, gamma=gamma, epsilon=epsilon, degree=degree_value, coef0=coef0_value, tol=tol, max_iter=max_iter)
                                svr_lon = SVR(C=C, kernel=kernel_value, gamma=gamma, epsilon=epsilon, degree=degree_value, coef0=coef0_value, tol=tol, max_iter=max_iter)
                                svr_alt = SVR(C=C, kernel=kernel_value, gamma=gamma, epsilon=epsilon, degree=degree_value, coef0=coef0_value, tol=tol, max_iter=max_iter)
