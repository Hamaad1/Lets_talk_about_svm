                ...
                for gamma_value in gamma:
                    for rep in range(repetitions):
                        if kernel_value == 'poly':                   
                            svr_lat = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon, degree=degree, coef0=coef0, tol=tol, max_iter=max_iter)
                            svr_lon = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon, degree=degree, coef0=coef0, tol=tol, max_iter=max_iter)
                            svr_alt = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon, degree=degree, coef0=coef0, tol=tol, max_iter=max_iter)
                            ...
                            svr_lat = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon, coef0=coef0, tol=tol, max_iter=max_iter)
                            svr_lon = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon, coef0=coef0, tol=tol, max_iter=max_iter)
                            svr_alt = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon, coef0=coef0, tol=tol, max_iter=max_iter)
