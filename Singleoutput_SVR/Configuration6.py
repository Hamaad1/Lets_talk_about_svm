...
def runSVR_C6(processed_data, base_name, results_directory,dataset_params, config):#  C, kernel_values,epsilon, degree_values,  gamma, tol, max_iter):
                                ...
                                for coef0_value in coef0:
                                    for rep in range(repetitions):
                                        if kernel_value in ['poly', 'sigmoid']:
                                            svr_lat = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon_value, degree=degree_value, coef0=coef0_value, tol=tol_value, max_iter=max_iter)
                                            svr_lon = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon_value, degree=degree_value, coef0=coef0_value, tol=tol_value, max_iter=max_iter)
                                            svr_alt = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon_value, degree=degree_value, coef0=coef0_value, tol=tol_value, max_iter=max_iter)
                                            ...
                                            tol_folder = os.path.join(split_folder, f"C_{C}", f"kernel_{kernel_value}",f"epsilon_{epsilon_value}", f"gamma_{gamma_value}", f"tol_{tol_value}")
                                            ...
                                            svr_lat = SVR(C=C, kernel=kernel_value, gamma=gamma_value,epsilon=epsilon_value, tol=tol_value, max_iter=max_iter)
                                            svr_lon = SVR(C=C, kernel=kernel_value, gamma=gamma_value,epsilon=epsilon_value, tol=tol_value, max_iter=max_iter)
                                            svr_alt = SVR(C=C, kernel=kernel_value, gamma=gamma_value,epsilon=epsilon_value, tol=tol_value, max_iter=max_iter)
