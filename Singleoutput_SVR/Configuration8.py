...
def runSVR_C8(processed_data, base_name, results_directory,dataset_params, config):
                                ...
                                for coef0_value in coef0:
                                    for rep in range(repetitions):
                                        if kernel_value == 'poly': 
                                            svr_lat = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon_value, degree=degree_value, tol=tol_value, max_iter=max_iter)
                                            svr_lon = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon_value, degree=degree_value, tol=tol_value, max_iter=max_iter)
                                            svr_alt = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon_value, degree=degree_value, tol=tol_value, max_iter=max_iter)
                                            ...
                                            print(f"Repetition {rep+1}/{repetitions}, Test size: {test_split}, C: {C}, "
                                            ...
                                            tol_folder = os.path.join(split_folder, f"C_{C}", f"kernel_{kernel_value}", f"gamma_{gamma_value}", f"epsilon_{epsilon_value}", f"degree_{degree_value}", f"tol_{tol_value}")
                                            ...
                                            svr_lat = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon_value, degree=degree_value, coef0=coef0_value, tol=tol, max_iter=max_iter)
                                            svr_lon = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon_value, degree=degree_value, coef0=coef0_value, tol=tol, max_iter=max_iter)
                                            svr_alt = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon_value, degree=degree_value, coef0=coef0_value, tol=tol, max_iter=max_iter)
                                            ...
                                            tol_folder = os.path.join(split_folder, f"C_{C}", f"kernel_{kernel_value}", f"gamma_{gamma_value}", f"epsilon_{epsilon_value}", f"Beta_{coef0_value}", f"tol_{tol_value}")
                                            if not os.path.exists(tol_folder):
                                                os.makedirs(tol_folder)                                                                              
                                            ...
                                            svr_lat = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon_value, tol=tol, max_iter=max_iter)
                                            svr_lon = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon_value, tol=tol, max_iter=max_iter)
                                            svr_alt = SVR(C=C, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon_value, tol=tol, max_iter=max_iter)
                                            ...
                                            tol_folder = os.path.join(split_folder, f"C_{C}", f"kernel_{kernel_value}", f"gamma_{gamma_value}", f"epsilon_{epsilon_value}", f"tol_{tol_value}")
                                            if not os.path.exists(tol_folder):
                                                os.makedirs(tol_folder)                         
                                            ...
                                            svr_lat = SVR(C=C, kernel=kernel_value, epsilon=epsilon_value, tol=tol, max_iter=max_iter)
                                            svr_lon = SVR(C=C, kernel=kernel_value, epsilon=epsilon_value, tol=tol, max_iter=max_iter)
                                            svr_alt = SVR(C=C, kernel=kernel_value, epsilon=epsilon_value, tol=tol, max_iter=max_iter)
                                            ...
                                            tol_folder = os.path.join(split_folder, f"C_{C}", f"kernel_{kernel_value}", f"epsilon_{epsilon_value}", f"tol_{tol_value}")
                                            if not os.path.exists(tol_folder):
                                                os.makedirs(tol_folder)
