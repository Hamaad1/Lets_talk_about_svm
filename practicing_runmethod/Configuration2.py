...
def runSVR_C2(processed_data, base_name, results_directory,dataset_params, config):#  C, kernel_values,epsilon, degree_values,  gamma, tol, max_iter):
   ...
   # Extract the training and testing data
    ...
    # After finishing loops, compare and save the best configuration
    #current_best_error = min(best_error, best_poly_error)  # Compare best errors across kernel types
    
    # if current_best_error < best_error:#remove these two lines
