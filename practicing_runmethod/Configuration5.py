            ...
            for C_value in C:
                if kernel_value in ['rbf', 'poly', 'sigmoid']:
                    for gamma_value in gamma:
                            ...
                            if kernel_value == 'poly':                              
                                for epsilon_value in epsilon:
                                    for degree_value in degree:
                                        for tol_value in tol:
                                            model = SVR(C=C_value, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon_value, degree=degree_value, tol=tol, max_iter=max_iter)
                                ...
                                for gamma_value in gamma:
                                    for coef0_value in coef0:
                                        for epsilon_value in epsilon:
                                            for tol_value in tol:
                                                model = SVR(C=C_value, kernel=kernel_value, gamma=gamma_value, epsilon=epsilon_value, degree=degree_value, coef0=coef0_value, tol=tol, max_iter=max_iter)
                                                model = MultiOutputRegressor(model, n_jobs=-1)
                        ...
                        for epsilon_value in epsilon:
                            for tol_value in tol:
                                #print(f"Running C={C_value}, epsilon={epsilon_value}, Kernel={kernel_value}")
                                model = SVR(C=C_value, kernel=kernel_value, epsilon=epsilon_value, tol=tol, max_iter=max_iter)
                                model = MultiOutputRegressor(model, n_jobs=-1)
