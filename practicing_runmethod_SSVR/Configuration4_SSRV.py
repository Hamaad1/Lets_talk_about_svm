                    ...
                    for gamma_value in gamma:
                        ...
                        for rep in range(repetitions):
                            if kernel_value in ['poly', 'sigmoid']:#== 'poly':
                                ...
                                svr_lat = SVR(C=C_value, kernel=kernel_value, gamma=gamma_value,epsilon=epsilon, tol=tol, max_iter=max_iter)
                                svr_lon = SVR(C=C_value, kernel=kernel_value, gamma=gamma_value,epsilon=epsilon, tol=tol, max_iter=max_iter)
                                svr_alt = SVR(C=C_value, kernel=kernel_value, gamma=gamma_value,epsilon=epsilon, tol=tol, max_iter=max_iter)
